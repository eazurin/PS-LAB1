...
#print(f"Caso prueba 4: Triángulo inválido, suma de dos de los números sea menor que el tercero - Resultado: {clasificacion}")
...
#print(f"Caso de prueba 5: Triángulo inválido, lado es igual a la suma de las longitudes de los otros dos lados - Resultado: {clasificacion}")
...
#print(f"Caso prueba 6: Carácter como entrada - Resultado: {clasificacion}")
...
#print(f"Caso prueba 7: Valor negativo como entrada - Resultado: {clasificacion}")
...
#print(f"Caso prueba 8: Valores decimales como entrada - Resultado: {clasificacion}")
...
#print(f"Caso de Prueba 9: Valor de un lado igual a 0 - Resultado: {clasificacion}")
...
#print(f"Caso prueba 10: Cadena como entrada - Resultado: {clasificacion}")
...
#print(f"Caso Prueba 11: Triángulo con valores booleanos - Resultado: {clasificacion}")
...
#print(f"Caso Prueba 12: Falta de Entrada - Resultado: {clasificacion}")

# Caso Prueba 13: Entrada incompleta
# Entrada: 4 5
# Resultado esperado: Debe ingresar todos los datos
#clasificacion = clasificar_triangulo(4, 5)
#print(f"Caso Prueba 13: Entrada incompleta - Resultado: {clasificacion}")
...
#print(f"Caso Prueba 14: Exceso de datos en la entrada - Resultado: {clasificacion}")
...
#clasificacion = clasificar_triangulo(int("4,000"), int("5,100"), int("4,300"))  
#print(f"Caso Prueba 15: Número con caracteres - Resultado: {clasificacion}")
